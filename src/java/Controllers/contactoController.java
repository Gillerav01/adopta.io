...
public class contactoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("contactar") != null){
            ...
            int idUsuario = udao.buscarIdUsuarioPorCorreo(u.getEmail());
            idao.crearIncidencia(new Incidencia(request.getParameter("motivo"), request.getParameter("descripcion"), "Sin atender", idUsuario));
